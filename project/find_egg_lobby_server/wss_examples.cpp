...
//#include <future>
//#include <experimental/coro>
//using namespace std;
//
//using WssServer = GameMasterServer::SocketServer<GameMasterServer::WSS>;
//using WssClient = GameMasterServer::SocketClient<GameMasterServer::WSS>;
//
//int main() {
...
//
//  // See http://www.boost.org/doc/libs/1_55_0/doc/html/boost_asio/reference.html, Error Codes for error code meanings
//  client.on_error = [](shared_ptr<WssClient::Connection> /*connection*/, const GameMasterServer::error_code &ec) {
