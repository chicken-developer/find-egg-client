#ifndef GAME_MASTER_STATUS_CODE_HPP
#define GAME_MASTER_STATUS_CODE_HPP
...
namespace GameMasterServer {
  ...
  inline StatusCode status_code(const std::string &status_code_string) noexcept {
    ...
    class StringToStatusCode : public std::unordered_map<std::string, GameMasterServer::StatusCode> {
    public:
      StringToStatusCode() {
...
#endif // GAME_MASTER_STATUS_CODE_HPP
